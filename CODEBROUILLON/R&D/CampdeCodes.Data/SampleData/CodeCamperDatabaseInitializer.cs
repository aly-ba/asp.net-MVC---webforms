...
namespace CampdeCodes.Data.SampleData
{ 
    public class CodeCamperDatabaseInitializer :
        CreateDatabaseIfNotExists<CampdeCodeDbContext>      // when model is stable
       // DropCreateDatabaseIfModelChanges<CampdeCodeDbContext> // when iterating
    {
        ...
        protected override void Seed(CampdeCodeDbContext context)
        {
            // Seed code here
        ...
        private List<Room> AddRooms(CampdeCodeDbContext context)
        {
        ...
        private List<TimeSlot> AddTimeSlots(CampdeCodeDbContext context)
        {
        ...
        private List<Track> AddTracks(CampdeCodeDbContext context)
        {
        ...
        private List<Person> AddPersons(CampdeCodeDbContext context, int count)
        {
        ...
        private void AddAttendance(CampdeCodeDbContext context, IEnumerable<Person> attendees)
        {
